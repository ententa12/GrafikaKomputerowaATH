...

{
	...
	// kolor tła - zawartośa bufora koloru
...

{
...

	{
		...
		// wysokośa okna większa od wysokości okna
		...
		if (width < height && width > 0)
			...
			// szerokośa okna większa lub równa wysokości okna
...

{
	...
	error = load_targa("hazel_tree_small.tga", width, height, format, type, pixels);
